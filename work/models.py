...
class Sheet(models.Model):
    ...
    a_capital_adequacy_ratio = models.DecimalField("A-自己資本比率", max_digits=5, decimal_places=1, null=True)
    ...
    b_capital_adequacy_ratio = models.DecimalField("B-自己資本比率", max_digits=5, decimal_places=1, null=True)
    ...
    c_capital_adequacy_ratio = models.DecimalField("C-自己資本比率", max_digits=5, decimal_places=1, null=True)
